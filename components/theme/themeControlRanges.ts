...
export const SCALE_CONTROLS = [
  ...
  { key: "focusRingWidth" as const, min: 0, max: 3, step: 0.5, unit: "px" },
  { key: "focusRingOffset" as const, min: 0, max: 4, step: 1, unit: "px" },
  { key: "textScale" as const, min: 0.95, max: 1.15, step: 0.025, unit: "×" },
] as const;
