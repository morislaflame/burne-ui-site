...
**Reduced motion:** squeeze is skipped inside `animateInteractivePressSqueeze` / `prefersReducedInteractiveHoverLift`.
...
Gloss submenu: `subContentGlossPanel` + `subContentGlossContent` instead of `bg-surface shadow-mid`.
