...
| `Popover.Label` | `h2` title |
| `Popover.Hint` | `FieldHint` subtitle |
...
Sizes affect padding, typography (`Popover.Label` / `Hint`), and default `gap`.
...
- `Popover.Label` / `Hint` linked via `labelId` / `hintId`
- `Escape` closes
